...
```json
{
  ...
  "type": "hello",
  "session_id": "b95e...",
  "capabilities": ["scene_manifest", "events", "recording", "multi_camera", "typed_visual_channels"],
...
`IBskMessageSource` permits future UDP and binary transports. Camera manifest
entries and `IBskCaptureProvider` reserve RGB, depth, and semantic segmentation
without adding those payloads to version 2 JSON frames.
