...
5. 必需检查：adapter-python；不要配置尚未注册或可被路径过滤跳过的检查。
...
```powershell
gh api --method PATCH repos/love-of-city/space_sim_UE_Adapter --input .github/repository-settings.json
gh api --method PUT repos/love-of-city/space_sim_UE_Adapter/branches/main/protection --input .github/branch-protection.json
gh api repos/love-of-city/space_sim_UE_Adapter/branches/main/protection
gh api repos/love-of-city/space_sim_UE_Adapter --jq '{allow_squash_merge,allow_merge_commit,allow_rebase_merge,delete_branch_on_merge}'
```
